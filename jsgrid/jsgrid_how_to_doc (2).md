...
| <!-- -->    | <!-- -->    |
|-------------|-------------|
|**Description :**  |  Specifies the number of entries that you want to display in
one page.
|**Syntax :**  |   PageSize
|**Type :**  |   Integer
|**Write/Read :**  |  write
...
| <!-- -->    | <!-- -->    |
|-------------|-------------|
|**Description :**  | Specifies the text that you want to display to open the next
page of data.
|**Syntax :**  | pageNextText
|**Type :**  |  String
|**Write/Read :**  | write
...
| <!-- -->    | <!-- -->    |
|-------------|-------------|
|**Description :**  |  Specifies the text that you want to display to open the
previous page
|**Syntax :**  |  pagePrevText
|**Type :**  | String
|**Write/Read :** | write
...
| <!-- -->    | <!-- -->    |
|-------------|-------------|
|**Description :**  |  Specifies the text that you want to display to open the first
page of data.
...
| <!-- -->    | <!-- -->    |
|-------------|-------------|
|**Description :**  | Specifies whether you want to display sample data on the
grid.
|**Syntax :**  |   sampleData
|**Type :**  |   Boolean
|**Write/Read :**  | write
...
| <!-- -->    | <!-- -->    |
|-------------|-------------|
|**Description :**  | Specifies the message that you want to display while the
...
|**Description :**  |  Specifies the message that you want to display to confirm a
delete operation.
...
|**Description :**  |  Specifies the message that you want to display when the user
enters invalid data.
...
|**Description :**  |  Specifies the message that you want to display when the data
array is empty.
...
|**Parameters :**  | *args [Array of JSON]* : The item that the user deleted from
the grid.

|**Example :**  |  this.view.jsGrid.onItemDeletion = function(args)
...
|**Parameters :**   | *args [Array of JSON]* : The item that the user added in the
grid.

|**Example :**  | this.view.jsGrid.onItemInsertion = function(args)
...
**Parameters :**  | *args [Array of JSON]* : The item that the user updated in the
grid.

**Example :**  this.view.jsGrid.onItemUpdation = function(args)
...
**Example :**  this.view.jsGrid.onErrorCallback= function(args)
...
**Parameters :**  header [Array of Strings] :A set of words that you want to
display as the headers of the grid.

data [Array of JSON] :A set of JSON objects that contain the column name and the
data that you want to enter into the grid.
